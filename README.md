...
<img width="1867" height="779" alt="image" src="https://github.com/user-attachments/assets/2ed7f678-f3df-4fed-8ab2-299e3218b13b" />
<img width="1850" height="772" alt="image" src="https://github.com/user-attachments/assets/1e2b1f29-f808-40b4-aaa9-4aabc96b5251" />
<img width="1903" height="801" alt="image" src="https://github.com/user-attachments/assets/33e97cc1-1741-440b-a4c2-50f20bef09f6" />
<img width="1902" height="831" alt="image" src="https://github.com/user-attachments/assets/efbcc8c6-f06b-4686-8363-5e35fc0dc736" />
<img width="1865" height="744" alt="image" src="https://github.com/user-attachments/assets/87e55f91-6dfc-48cd-a3b5-73822162c27a" />
<img width="1858" height="658" alt="image" src="https://github.com/user-attachments/assets/92b17058-c559-4cf0-99e7-abd9b4ee2d5e" />
...
- 接口：`GET /user/match`
- 会读取当前用户 `tags` 与其他用户 `tags` 计算相似度（标签交集数量）。
- 按“相同标签数量”从高到低排序，返回最匹配的用户列表。
